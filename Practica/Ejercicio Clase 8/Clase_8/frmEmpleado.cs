...
namespace Clase_8
{
    public partial class frmEmpleado : Form
    {
        ...
        private void btnAgregarItem_Click(object sender, EventArgs e)
        {
            ...
            //Alumno
            Empleado empleado = new Empleado(txtNombre.Text, txtApellido.Text, mtxtLegajo.Text, (Empleado.EPuestoJerarquico)cmbPuesto.SelectedValue, Convert.ToInt32(mtxtSalario.Text.Substring(1)));
